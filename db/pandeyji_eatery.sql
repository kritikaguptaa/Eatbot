CREATE DATABASE  IF NOT EXISTS `Beijing's delight` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `Beijing's delight`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: Beijing's delight
-- ------------------------------------------------------
...
INSERT INTO `food_items` VALUES (1,'Pav Bhaji',60),(2,'Chole Bhature',7.00),(3,'Pizza',8.00),(4,'Mango Lassi',5.00),(5,'Masala Dosa',6.00),(6,'Vegetable Biryani',9.00),(7,'Vada Pav',4.00),(8,'Rava Dosa',7.00),(9,'Samosa',5.00);
...
--
-- Dumping routines for database 'Beijing's delight'
--
